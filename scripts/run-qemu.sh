...
case $1 in
    ...
    i386 )
        ...
        ;;
    debug )
        qemu-system-x86_64 -s -S -smp 1 -m 512 -nographic -kernel ../linux-3.0/arch/x86/boot/bzImage -append "root=/dev/sda rw init=/sbin/init norandmaps console=ttyS0,115200 debug" -hda ../disk_images/rootfs.ext3 -net nic,model=e1000 -net user
        ;;
    * )
